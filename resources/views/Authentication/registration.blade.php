...
<html>
	...
	<body>
		<br><br>
		<form action="{{URL::to('add_user')}}" method="POST" style="padding: 150px;">
			@csrf
		  <div class="form-group col-lg-10 col-md-10 col-sm-10">
		    <label for="exampleFormControlInput1">First Name</label>
		    <input type="text" class="form-control" id="exampleFormControlInput1" name="fname" placeholder="First Name">
		  </div>
		  <div class="form-group col-lg-10 col-md-10 col-sm-10">
		    <label for="exampleFormControlInput1">Last Name</label>
		    <input type="text" class="form-control" id="exampleFormControlInput1" name="lname" placeholder="Last Name">
		  </div>
		  <div class="form-group col-lg-10 col-md-10 col-sm-10">
		  ...
		  <div class="form-group col-lg-10 col-md-10 col-sm-10">
		    ...
		    <input type="text" class="form-control" id="exampleFormControlInput1"name="city" placeholder="City">
		  </div>
		  <div class="form-group col-lg-10 col-md-10 col-sm-10">
